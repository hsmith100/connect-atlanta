// API Route: Artist/DJ Application Proxy
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const response = await fetch(`${backendUrl}/api/forms/artist-application`, {
      method: 'POST',
      headers: {
    ...
    console.error('Artist application proxy error:', error);
