// API Route: Volunteer Application Proxy
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const response = await fetch(`${backendUrl}/api/forms/volunteer-application`, {
      method: 'POST',
      headers: {
    ...
    console.error('Volunteer application proxy error:', error);
