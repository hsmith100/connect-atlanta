// API Route: Vendor Application Proxy
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const response = await fetch(`${backendUrl}/api/forms/vendor-application`, {
      method: 'POST',
      headers: {
    ...
    console.error('Vendor application proxy error:', error);
